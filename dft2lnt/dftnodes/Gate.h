...
protected:
    // TODO: check why Gate is commented out here and moved to public
...
public:
    ...
    Gate(Location loc, std::string name, DFT::Nodes::NodeType nodeType): Node(loc,name,nodeType), active(false), initialized(false) {
    }
